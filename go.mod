module github.com/jtarchie/forum
...
require (
	...
	github.com/jtarchie/middleware v0.0.0-20230621112741-7333d5cc084e
...
require (
	...
	github.com/nabowler/echo-gothic v0.0.0-20210125020527-7a705746908f // indirect
...
replace encoding/json => github.com/goccy/go-json v0.10.2
